...
class Animated_sprite(pygame.sprite.Sprite):
    ...
    def __init__(self, x,y , frames, groups, name):
        ...
        if self.name=="fire":
            ...
            self.rect = self.rect.inflate(0, -180)
            self.ani_speed = random.uniform(0.1, 0.3)
        else :
    ...
    def update(self, screen, screen_scroll):
        ...
        self.animate()
        self.rect.x += screen_scroll
        # pygame.draw.rect(screen, "red", self.rect,2,1)
